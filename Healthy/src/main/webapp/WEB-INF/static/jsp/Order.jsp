  		...
  		$(function(){
  			$("#UserTab").datagrid({
  				...
  				columns:[[
  					...
  					{field:'oid',title:'订单号',width:100,align:'center'},
  					{field:'doctorid',title:'医生号',width:100,align:'center'},
  					{field:'dname',title:'医生昵称',width:200,align:'center'},
  					{field:'userid',title:'用户号',width:300,align:'center'},
  					{field:'uname',title:'用户名称',width:300,align:'center'},
  					{field:'money',title:'费用',width:300,align:'center'},
  					{field:'zid',title:'状态',width:300,align:'center'},
  					{field:'ostate',title:'结算状态',width:300,align:'center'},
  				  	{field:'grade',title:'身份',width:300,align:'center'},
  				]],
  				idField:'id',//创建表格必须加上;
  				//显示斑马线效果
  				striped:true,
