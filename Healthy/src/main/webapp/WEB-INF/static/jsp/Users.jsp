<%@ page language="java" import="java.util.*,com.dao.UserMapper,org.springframework.context.ApplicationContext,org.springframework.context.support.ClassPathXmlApplicationContext" pageEncoding="UTF-8"%>
<%
...
<%
	...
	int chouse=userMapper.countUsers();
	int count=chouse;
	chouse=chouse%3==0?chouse/3:chouse/3+1;
	chouse=chouse%3==0?chouse:chouse+1;
 %>
